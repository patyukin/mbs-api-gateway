...
func (h *Handler) GetCreditApplicationV1(w http.ResponseWriter, r *http.Request) {
	...
	response, err := h.cuc.GetCreditApplicationUseCase(r.Context(), applicationID, userID)
	if err != nil {

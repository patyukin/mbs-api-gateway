...
func (h *Handler) GetUserReportV1(w http.ResponseWriter, r *http.Request) {
	...
	if in.UserID == "" {
		...
		log.Error().Msg("GetUserReportV1 missing userID")
	...
	if err := in.Validate(); err != nil {
		metrics.FailedLogReport.Inc()
		log.Error().Msgf("GetUserReportV1 ValidateError: %v", err.Description)

...
func (u *UseCase) ConfirmationPaymentV1UseCase(
	ctx context.Context, in model.ConfirmationPaymentV1Request, userID string,
	...
	return model.VerifyPaymentV1Response{Message: result.GetMessage()}, nil
}
